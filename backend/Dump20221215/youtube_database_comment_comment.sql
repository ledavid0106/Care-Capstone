...
CREATE TABLE `comment_comment` (
  ...
  PRIMARY KEY (`id`),
  KEY `comment_comment_user_id_6078e57b_fk_authentication_user_id` (`user_id`),
  CONSTRAINT `comment_comment_user_id_6078e57b_fk_authentication_user_id` FOREIGN KEY (`user_id`) REFERENCES `authentication_user` (`id`)
...
INSERT INTO `comment_comment` VALUES (1,'1','asdasdas',1111,2,1),(2,'2','saul and david and dogs and cats',100000,0,1),(3,'2','no',2000,1,1),(4,'1','test',100000,0,2),(5,'2','testing',100000,0,1);
