...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(8,'cards_app','card'),(7,'collections_app','collection'),(5,'contenttypes','contenttype'),(6,'sessions','session');
